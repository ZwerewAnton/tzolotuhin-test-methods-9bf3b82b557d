...
public class Browser implements Closeable {
    ...
    public Browser() {
        ...
        try {
            ...
            if (System.getProperty("os.name").toLowerCase().contains("win")) {
                System.setProperty("webdriver.chrome.driver", "./lib/chromedriver4.exe");
    ...
    public String getAlert(){
        Alert alert = (new WebDriverWait(webDriver, 10))
    ...
    public void makeScreenshot1() {
        byte[] screenshot;
        try {
            screenshot = ImageUtils.toByteArray(((TakesScreenshot)webDriver).getScreenshotAs(OutputType.FILE));
            FileOutputStream fos = new FileOutputStream("./lib/windows.png");
